...
const Return = () => {
  ...
  const [usedMileage, setUsedMileage] = useState(1);
  ...
  const onConfirm = () => {
    if (usedMileage === '' && rentalPeriod === '') {
      alert('Please Insert Mileage or Rental Period');
    } else {
      cars.map((car) => {
  ...
  return (
    <div className='checkout'>
      <h3 className='checkout__header'> Return</h3>
      <div className='checkout__container'>
        <div className='checkout__customerInfo'>
          ...
          <div>
            ...
            <input className='checkout__customerInfoInput' type='number' onChange={(e) => setUsedMileage(e.target.value)} Placeholder=' Enter used Mileage' />
          </div>

          <br />
          <div className='mt-2'>
            <span>Rental Period: </span>
            <input className='checkout__customerInfoInput' type='number' onChange={(e) => setRentalPeriod(e.target.value)} Placeholder=' Rental Period' /> Days
          </div>
          ...
          <div className='checkout__reviewCar'>
            ...
            <div className='checkout__bookingInfo'>
              ...
              <p>
                ...
                <strong>
                  $
                  {parseFloat(rentalPeriod) > parseFloat(usedMileage) / parseFloat(rentalPeriod)
                    ? parseFloat(state.carInfo.price) * parseFloat(rentalPeriod)
                    : parseFloat(state.carInfo.price) * (parseFloat(usedMileage) / parseFloat(rentalPeriod))}{' '}
                  {/* {parseFloat(state.carInfo.price) * parseFloat(rentalPeriod)}{' '} */}
                </strong>
              </p>
